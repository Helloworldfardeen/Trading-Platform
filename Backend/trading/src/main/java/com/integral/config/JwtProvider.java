...
public class JwtProvider {
	private static SecretKey key = Keys.hmacShaKeyFor(JwtConstant.SCREACT_KEY.getBytes());
	...
	// using this method you can access the email by providing by jwt token
